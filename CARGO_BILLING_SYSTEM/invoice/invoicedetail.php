...
<div class="submenu" id="submenu">
	 ...
	 <a href="../invoice.php?Invoice_No=<?php echo $invoiceno; ?>" target="_blank" class="unactive" name="Print">Print</a>
...
<!-- customer detail -->
			...
			<div class="card bg-info text-white">
				<div style="margin:5px 0px 0px 10px;"><h5><b>Invoice Detail</b> <button id="cancelInvoicebtn" style="float: right; margin-right: 50px;" class="btn btn-warning">Cancel</button> <button id="saveInvoicedetailbtn" class="btn btn-success" style="float: right; margin-right: 40px;"><i class="fa fa-remove"></i>Save</button></h5>
				</div>
