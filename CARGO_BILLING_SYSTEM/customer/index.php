...
?>
 ...
 <div class="submenu" id="submenu">
		  <a href="../customer" class="active" name="Invoice">Search</a>
		  <a href="customerlist.php" class="unactive" name="Inventory">Customer Detail</a>
	...
	<div class="row">
		<div class="col-md-7">
			...
			<div class="card bg-info text-white">
				<div style="margin:5px 0px 0px 10px; "><h5><b>Recently Added Customer</b></h5></div>
			</div>
...
<!-- Serach customer -->
		<div class="col-md-5">
			<div class="card border-info">
			<div class="card bg-info text-white">
				<div style="margin:5px 0px 0px 10px; "><h5><b>Search Customer</b></h5></div>
			</div>
			<div class="card-body">
				<form action="customerlist.php" method="POST" id="searchCustomerForm">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <input type="mobile" class="form-control" id="searchMobile" name="searchMobile" maxlength="10">
				    </div>
				  </div>
				   <div class="form-group row">
			...
			<div class="card bg-info text-white">
				<div style="margin:5px 0px 0px 10px; "><h5><b>Add Customer</b></h5></div>
			</div>
			<div class="card-body">
